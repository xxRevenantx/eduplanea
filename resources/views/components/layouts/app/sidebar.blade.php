...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <a href="{{ route('dashboard') }}"
       class="me-5 flex items-center space-x-2 rtl:space-x-reverse px-1"
       wire:navigate
    >
        <x-app-logo />
    </a>
    ...
    <div class="mt-4 rounded-2xl border border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900  px-3.5 py-3 flex flex-col gap-3 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
        {{-- Encabezado usuario --}}
        <div class="flex items-center justify-between gap-2">
            ...
            <flux:dropdown class="hidden lg:inline-flex" position="bottom" align="end">
                <button type="button" class="inline-flex h-7 w-7 items-center justify-center rounded-lg bg-zinc-800 text-zinc-300 hover:bg-zinc-700">
        ...
        <flux:navlist
            {{-- variant="ghost" --}}
            class="mt-1 space-y-1 [&>div]:border-0 [&>div]:p-0"
        >
    ...
    {{-- Sección inferior: Plantillas / Integraciones --}}
    <flux:navlist
        variant="ghost"
        class="space-y-1 text-[13px] text-zinc-300"
    >
        <flux:navlist.item
            icon="layout-dashboard"
            href="#"
            class="rounded-xl px-2.5 py-2 hover:bg-zinc-900 hover:text-zinc-50"
        >
            Plantillas
        </flux:navlist.item>
    ...
    {{-- Dropdown completo solo para escritorio (ya lo tenías) --}}
    <flux:dropdown class="hidden lg:block mt-3" position="bottom" align="start">
        <flux:profile
            :name="auth()->user()->name"
